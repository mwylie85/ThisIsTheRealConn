...
Public Class Service1
    ...
    Dim ConStr As String = "Host=sql2.freemysqlhosting.net;Port=5273;Database=sql27927;user=sql27927;Password=rS9!uH8!"
    ...
    Public Function getOneRow(ByVal sqlQuery As String) As List(Of IService1.eventDetails) Implements IService1.getOneRow
        ...
        Dim p As New MySqlConnectionStringBuilder
        p.Server = "sql2.freemysqlhosting.net"
        p.UserID = "sql27927"
        p.Password = "rS9!uH8!"
        p.Database = "sql27927"
        Dim con As New MySqlConnection(p.ToString)
        ...
        Try
            ...
            'loop through all row returned from the database
